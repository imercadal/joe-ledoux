...
},
{
 ...
 },
 {
  ...
  },
  {
    ...
    event: "Parma University, International School of Ethology 3rd Workshop: Ethology & Psychobiology of Fear and Defence",
  ...
  {
    id: "192",
    title: 'Lecture: "Information flow from sensation to emotion: sensory pathways to the amygdala involved in fear & anxiety"',
    event: "3rd Annual NS Day @ Dartmouth College, Hanover, NH: 'A Neural Systems Analysis of Fear & Anxiety' Symposium ",
    date: new Date("1989-01-27"),
  },
  {
    id: "193",
    title: 'Representation of affect in neural circuits',
    event: "1989 FESN Study Group on Learning and Memory. Geneva, Switzerland",
  ...
  {
    id: "210",
    title: '4th Conference on the Neurobiology of Learning & Memory: "Memory: Organization & Locus of Change" — Presentation: "Functional Roles of Brain Systems"',
    event: "Irvine, California",
  ...
  {
    id: "215",
    title: 'Neurology Grand Rounds: "Indelible Emotional Memories in the Brain"',
    event: "Nassau County Medical Center, East Meadow, NY",
    date: new Date("1991-01-11"),
  },
  {
    id: "216",
    title: "Dept of NS & Cell Biology Seminar",
    event: "Robert Wood Johnson Medical School, UMDNJ, Piscataway, NJ",
    date: new Date("1991-02-05"),
  },
  {
    id: "217",
    title: "Neurobiology Seminar Series",
    event: "NYU Medical Center, New York, NY",
    date: new Date("1991-02-11"),
  },
  {
    id: "218",
    title: 'Neuropsychology Colloquium: "Emotional Memories: Indelible Neural Traces"',
    event: "Queens College, Queens, NY",
    date: new Date("1991-02-13"),
  },
  {
    id: "219",
    title: '"Emotion & Memory" Lecture for Neuroscience Course for General Faculty Council',
    event: "Cornell Medical Center, New York, NY",
    date: new Date("1991-04-17"),
  },
  {
    id: "220",
    title: '3rd Annual Dean\'s Day Lecture: "Emotional Memory and the Brain"',
    event: "NYU, New York, NY",
    date: new Date("1991-05-04"),
  },
  {
    id: "221",
    title: "Brain Mechanisms in Emotion and Memory",
    event: "NY Academy of Sciences, New York, NY",
    date: new Date("1991-05-13"),
  },
  {
    id: "222",
    title: '"Limbic Memory Learning" Lecture at Fundamental Neurobiological Approaches to Disease',
    event: "The Neurosciences Institute, New York, NY",
    date: new Date("1991-05-19"),
  },
  {
    id: "223",
    title: "Neurons, Vision and Cognition Symposium",
    event: "NYU, New York, NY",
    date: new Date("1991-05-28"),
  },
  {
    id: "224",
    title: 'Lecture: "Advances in Modern Biological Sciences"',
    event: "Faculty Resource Network, NYU, New York, NY",
    date: new Date("1991-05-06"),
  },
  {
    id: "225",
    title: 'NRI Rockefeller',
    event: "Rockefeller University, New York, NY",
    date: new Date("1991-05-23"),
  },
  {
    id: "226",
    title: '3rd Annual APS Convention — Presidential Symposium: "Emotion and Memory: Emotional Circuits & Their Memories"',
    event: "Washington, DC",
    date: new Date("1991-06-13"),
  },
  {
    id: "227",
    title: "Psychology Dept. Colloquium Talk",
    event: "Brown University, Providence, RI",
    date: new Date("1991-06-27"),
  },
  {
    id: "228",
    title: '"Brain & Emotion" Lecture, James S, McDonnell Foundation Summer Institute in Cognitive Neuroscience',
    event: "Dartmouth College & Medical School, Hanover, NH",
    date: new Date("1991-07-01"),
  },
  {
    id: "229",
    title: 'Brown University',
    event: "Providence, RI",
    date: new Date("1991-09-25"),
  },
  {
    id: "230",
    title: 'Swiss Psychology Summer School: "Emotion and Behavior" + University of Geneva Talk: "Emotional Systems of the Brain"',
    event: "Montreux and Geneva, Switzerland",
    date: new Date("1991-10-07"),
  },
  {
    id: "231",
    title: "Memoria: The Memory Culture of the Middle Ages & Renaissance",
    event: "Maison Francoise, NYU, New York, NY",
    date: new Date("1991-10-10"),
  },
  {
    id: "232",
    title: "Hemholtz Club Presentation",
    event: "UC Irvine, Irvine, California",
    date: new Date("1991-10-28"),
  },
  {
    id: "233",
    title: 'SFN Symposium: "Behavioral Neuroscience: What Do Amygdala Neurons Know?"',
    event: "New Orleans, Louisiana",
    date: new Date("1991-11-14"),
  },
  {
    id: "234",
    title: "Department of Psychology Lecture",
    event: "Brooklyn College, Brooklyn, NY",
    date: new Date("1991-11-25"),
  },
  {
    id: "235",
    title: "McDonnell-Pew Cognitive Neuroscience Colloquium",
    event: "MIT, Cambridge, MA",
    date: new Date("1991-12-05"),
  },
  {
    id: "236",
