...
export default function CareerCelebrationClient() {
    const [selectedPhoto, setSelectedPhoto] = useState<CareerImage | null>(null);
    const [selectedProgramImage, setSelectedProgramImage] = useState<CareerImage | null>(null);
