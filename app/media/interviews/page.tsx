...
export default async function InterviewsPage() {
  ...
  apiUrl.searchParams.set('group', 'interviews');
  ...
  try {
    ...
    const bannerImage = bannerImages['interviews'];
    
    return (
      <section className="bg-darkest min-h-[calc(100vh-170px)]">
        <Banner imageUrl={bannerImage} title="Interviews" />
    ...
    return (
      <section className="bg-darkest min-h-[calc(100vh-170px)]">
        <div className="relative mb-8 h-40 bg-cover bg-center bg-[url('/310_Author_Books.webp')] flex items-center justify-center">
          <h3 className="font-bold uppercase">Interviews</h3>
        </div>
