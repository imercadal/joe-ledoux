...
export default function NewsImageGrid({ images, className = "" }: PhotoGalleryProps) {
  ...
  return (
    <div className={`w-full max-w-4xl mx-auto ${className}`}>
      <div className="relative sm:static sm:max-h-none sm:overflow-visible max-h-60 overflow-hidden">
        <div className="grid grid-cols-1 sm:grid-cols-4 gap-4 auto-rows-min">
        {images.map((image) => {
          let spanClass = "";
          if (image.id === "1") {
        ...
        <div className="pointer-events-none absolute bottom-0 left-0 w-full h-10 bg-gradient-to-t from-lightText to-transparent sm:hidden" />
      </div>
