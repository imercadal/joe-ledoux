...
export default function Navbar() {
  ...
  const neuroscientistItems = [
    { label: "publications", href: "/neuroscientist" },
  ...
  const musicianItems = [
    ...
    { label: "so we are", href: "/musician/soweare" },
    { label: "solo projects", href: "/musician/soloprojects" },
    {
      label: "media",
      submenu: [
  ...
  return (
    <header className="bg-white">
      <nav
        aria-label="Global"
        className="mx-auto max-w-4xl flex md:flex-col items-center justify-between p-4 lg:px-8"
      >
        <div className="p-2">
          <Link href="/">
            <h1>JOSEPH LEDOUX</h1>
